...
class ViewController: UIViewController
{
    ...
    override func viewDidLoad()
    {
        ...
        emailField.placeholder = "justin@secondgear.io"
...
let emailLeadingEdgeConstraint = NSLayoutConstraint(item: emailLabel, attribute: .Leading, relatedBy: .Equal, toItem: emailField, attribute: .Leading, multiplier: 1.0, constant: 0.0)
